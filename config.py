...
class Config:
    def __init__(self):
        ...
        # Support Links
        self.SUPPORT_CHANNEL: str = getenv("SUPPORT_CHANNEL", "https://t.me/DEATHMUSICBOTSUPPORT")
        ...
        # Images
        self.DEFAULT_THUMB: str = getenv("DEFAULT_THUMB", "https://t.me/SAGEBOTMATERIAL/20")
        self.PING_IMG: str = getenv("PING_IMG", "https://t.me/SAGEBOTMATERIAL/20")
        self.START_IMG: str = getenv("START_IMG", "https://t.me/SAGEBOTMATERIAL/20")
        self.RADIO_IMG: str = getenv("RADIO_IMG", "https://t.me/SAGEBOTMATERIAL/20")
